...
_FALLBACK: State = (S.ESTIMATING, A.ESTIMATE_INCOMPLETE)
...
_GRAPH: dict[State, frozenset[State]] = {
    ...
    _OUTREACH: frozenset({_SEARCH, _GATHER, _ESTIMATE, _POLICY, _FALLBACK, _WAIT, _CONTROLLER}),
    _FALLBACK: frozenset({_POLICY, _CONTROLLER}),
